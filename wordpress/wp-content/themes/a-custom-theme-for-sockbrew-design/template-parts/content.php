...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		...
		the_content(
			sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'a-custom-theme-for-sockbrew-design' ),
					array(
						'span' => array(
							'class' => array(),
						),
		...
		wp_link_pages(
			array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'a-custom-theme-for-sockbrew-design' ),
				'after'  => '</div>',
			)
		);
		?>
